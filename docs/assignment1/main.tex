...
The function \texttt{swap}\_\texttt{vals} takes as input the address of two integer variables, \texttt{a} and \texttt{b} exchange the value of two variables \texttt{a} and \texttt{b} first storing the value of one \texttt{a} in a temporary variable \texttt{temp}. In order to swap the values of two arrays, this function is iteratively applied to each element of two arrays \texttt{A} and \texttt{B} of equal length.
